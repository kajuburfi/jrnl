...
pub fn get_headings(filename: &str) -> Vec<String> {
...
pub fn add_date_to_file(filename: &str, date: DateTime<Local>) -> std::io::Result<()> {
...
pub fn get_entry(date: DateTime<Local>) -> String {
